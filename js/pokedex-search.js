		...
		for (let i = 0; i < list.length; i++) {
			...
			buf += '<li class="result">' +
				'<a href="' + Config.baseurl + 'trainers/' + t.id + '" data-target="push">' +
					'<span class="col namecol" style="display:inline-block;vertical-align:middle">' + display + '</span>' +
					'<span class="col" style="float:right;text-align:right;white-space:nowrap;display:flex;align-items:center;gap:2px">' + teamSprites + '</span>' +
				'</a>' +
			'</li>';
		}
		buf += '</ul>';
